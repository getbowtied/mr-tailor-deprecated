...
<div class="slider_metabox">
    ...
    <?php if ($mb->is_value('style_4')) { ?><style>.slider_height {display:block}</style><?php } ?>
    ...
    <?php if($mb->is_value('1')) { ?><style>.slider_autoplay_delay {display:block}</style><?php } ?>
...
<script>
	...
	jQuery(function($){
		...
		// hide slider_height
		$('.slider_metabox').on("click", "#style_1", function() {		
